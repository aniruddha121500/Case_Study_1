...
The summary statistic of the percent of the population that is aged $18$ to $24$.
```{r, echo = TRUE}

```

The summary statistic of the percent of the population that is aged $65$ or older.
```{r, echo = TRUE}

```

The summary statistic of the number of active nonfederal physicians during $1990$ is shown below.
```{r, echo = TRUE}

```

The summary statistic of the number of beds, cribs and bassinets during $1990$ is shown below.
```{r, echo = TRUE}
...
# Summary Statistics
# cdi.PercentPop18_24 = summary(cdi$PercentPop18_24) DONE
# cdi.PercentPop65_ = summary(cdi$PercentPop65_)     DONE
# cdi.Num_Active_Phy = summary(cdi$Num_Active_Phy)   DONE
# cdi.Num_Hosp_Beds = summary(cdi$Num_Hosp_Beds)     DONE
